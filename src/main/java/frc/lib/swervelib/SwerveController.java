...
public class SwerveController
{
  ...
  /**
   * PID Controller for the robot snap heading.
   */
  public final PIDController                 snapController; // TODO: Switch to ProfilePIDController
  /**
  ...
  public SwerveController(SwerveControllerConfiguration cfg)
  {
    ...
    thetaController.setTolerance(Math.toRadians(0.1));
    thetaController.enableContinuousInput(-Math.PI, Math.PI);
    snapController = config.snapPIDF.createPIDController();
    snapController.setTolerance(Math.toRadians(0.1));
   ...
   */
  public double headingCalculate(double currentHeadingAngleRadians, double targetHeadingAngleRadians, boolean useSnap)
  {
    return useSnap ? snapController.calculate(currentHeadingAngleRadians, targetHeadingAngleRadians)
                   : thetaController.calculate(currentHeadingAngleRadians, targetHeadingAngleRadians);
  }
