...
/**
 * Simulation for {@link SecondOrderSwerveDrive.SwerveDrive} IMU.
 */
public class SwerveIMUSimulation
{
  ...
  /**
   * Update the odometry of the simulated {@link SecondOrderSwerveDrive.SwerveDrive} and post the {@link swervelib.SwerveModule}
